...
export default function NewNavBar({companyName="Homes by Jose Solis"}) {
        ...
        >
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="me-auto">
                    ...
                    {authState ? (
                        <React.Fragment>
                            <Nav.Link as={Link} to="/age-graph" className={pos === "top" ? "text-light": "text-dark"}>Age Graph</Nav.Link>
                            <Nav.Link as={Link} to="/messages" className={pos === "top" ? "text-light": "text-dark"}>Contact Me Messages</Nav.Link>
                            <Nav.Link as={Link} to="looking-to-buy" className={pos === "top" ? "text-light": "text-dark"}>Looking For Home</Nav.Link>
